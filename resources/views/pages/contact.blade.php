...
<section class="bg-gradient-warm text-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl md:text-5xl font-heading font-extrabold mb-4">Contáctanos</h1>
        <p class="text-xl text-primary-100">¿Tienes preguntas o quieres saber más? Estamos aquí para escucharte.</p>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-md">
                <h2 class="text-2xl font-heading font-bold text-gray-800 mb-6">Envíanos un Mensaje</h2>
                ...
                <form action="{{ route('contact.store') }}" method="POST" class="space-y-5">
                    ...
                    <div class="grid sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="subject" value="{{ old('subject') }}" class="form-input" placeholder="¿En qué podemos ayudarte?">
                        </div>
                    </div>
                    <div>
                        <label class="form-label">Mensaje *</label>
                        <textarea name="message" rows="5" class="form-input @error('message') border-red-400 @enderror" placeholder="Escribe tu mensaje aquí...">{{ old('message') }}</textarea>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <a href="mailto:{{ $siteSettings['contact_email'] }}" class="text-primary-600 hover:underline">{{ $siteSettings['contact_email'] }}</a>
                    </div>
                </div>
                @endif
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">{{ $siteSettings['contact_phone'] }}</p>
                    </div>
                </div>
                @endif
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <a href="https://wa.me/{{ preg_replace('/\D/', '', $siteSettings['contact_whatsapp']) }}" target="_blank" class="text-green-600 hover:underline font-medium">Escríbenos por WhatsApp →</a>
                    </div>
                </div>
                @endif
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm flex items-start gap-4">
                    ...
                    <div>
                        <h3 class="font-semibold text-gray-800 mb-1">Dirección</h3>
                        <p class="text-gray-600">{{ $siteSettings['contact_address'] }}</p>
                        @if(!empty($siteSettings['contact_city']))
                        <p class="text-gray-500 text-sm">{{ $siteSettings['contact_city'] }}</p>
                        @endif
                    </div>
                </div>
                @endif
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-sm">
                    <iframe src="{{ $siteSettings['google_maps_url'] }}" width="100%" height="220" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                @endif
            </div>
        </div>
