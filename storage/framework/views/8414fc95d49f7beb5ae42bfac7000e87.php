<?php $__env->startSection('title', 'Donaciones'); ?>
...
<section class="section-padding bg-warm-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($siteSettings['donation_bank']) || !empty($siteSettings['donation_clabe'])): ?>
        <div class="bg-white rounded-3xl shadow-md p-8 mb-8">
            ...
            <div class="space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($siteSettings['donation_bank'])): ?>
                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                    <span class="text-gray-500 font-medium">Banco</span>
                    <span class="font-semibold text-gray-800"><?php echo e($siteSettings['donation_bank']); ?></span>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($siteSettings['donation_account'])): ?>
                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                    <span class="text-gray-500 font-medium">Número de Cuenta</span>
                    <span class="font-mono font-semibold text-gray-800 text-lg"><?php echo e($siteSettings['donation_account']); ?></span>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($siteSettings['donation_clabe'])): ?>
                <div class="flex justify-between items-center py-3 border-b border-gray-100">
                    <span class="text-gray-500 font-medium">CLABE Interbancaria</span>
                    <span class="font-mono font-semibold text-gray-800 text-lg"><?php echo e($siteSettings['donation_clabe']); ?></span>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <p class="text-xs text-gray-400 mt-4 italic">Por favor envía tu comprobante de pago a: <a href="mailto:<?php echo e($siteSettings['contact_email'] ?? ''); ?>" class="text-primary-600 hover:underline"><?php echo e($siteSettings['contact_email'] ?? 'contacto@sinergiadamoriesperanza.org'); ?></a></p>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($siteSettings['donation_paypal'])): ?>
        <div class="bg-blue-50 border border-blue-200 rounded-3xl p-8 mb-8 text-center">
            ...
            <a href="<?php echo e($siteSettings['donation_paypal']); ?>" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 text-white font-bold rounded-full hover:bg-blue-700 transition-colors shadow-md">
                Donar con PayPal
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/alejandroleon/Documents/PROYECTOS CLIENTES/SINERGIA-WEB/resources/views/pages/donations.blade.php ENDPATH**/ ?>