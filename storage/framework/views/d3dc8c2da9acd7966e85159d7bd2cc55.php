...
<head>
    ...
    <?php if(!empty($siteSettings['site_favicon'])): ?>
        <link rel="icon" type="image/x-icon" href="<?php echo e(asset('images/' . $siteSettings['site_favicon'])); ?>">
    <?php endif; ?>
...
<body class="bg-warm-50" x-data="{ menuOpen: false }">
            ...
            <div class="flex items-center justify-between h-20">
                ...
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 flex-shrink-0">
                    <?php if(!empty($siteSettings['site_logo'])): ?>
                        <img src="<?php echo e(asset('images/' . $siteSettings['site_logo'])); ?>" alt="<?php echo e($siteSettings['site_name'] ?? 'Sinergia A.C.'); ?>" class="h-12 w-auto">
                    <?php else: ?>
    ...
    <?php if(!empty($siteSettings['contact_whatsapp'])): ?>
